  ...
  const mostrarModal = (name) =>{
    ...
    return (
      <div className={styles.container}>
        ...
        <Card nombre="Juan Diaz" puesto="Desarrollador" onClick={()=>mostrarModal("Juan Diaz")} />
        <Card nombre="Mauricio M." puesto="Desarrollador" onClick={()=>mostrarModal("Mauricio Munguia")} />
